    ...
    <div id="wd-assignments">
      ...
      <ul id="wd-assignment-list">
        ...
        <li className="wd-assignment-list-item">
          ...
          <br />
          Multiple Modules | <b>Not available until</b> May 27 at 12:00am |<br />
          <b>Due</b> Jun 3 at 11:59pm | 100 pts
        </li>

        <li className="wd-assignment-list-item">
          <Link
            href="/courses/1234/assignments/567"
            className="wd-assignment-link"
          >
            A5 - FINAL PROJECT
          </Link>
          <br />
          Multiple Modules | <b>Not available until</b> Jun 3 at 12:00am |<br />
